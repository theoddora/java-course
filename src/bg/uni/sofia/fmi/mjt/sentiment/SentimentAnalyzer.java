...
public interface SentimentAnalyzer
{
     ...
     * @return the review sentiment as a floating-point number in the interval [0.0, 4.0] if known, and -1.0 if unknown
     */
     ...
     * @param review
     *            the text of the review
     * @return the review sentiment as a name: "negative", "somewhat negative", "neutral", "somewhat positive",
     *         "positive" or "unknown". Standard rounding rules apply, e.g. 1.49 is "somewhat negative" while 1.50 is
     *         "neutral"
     */
    ...
    /**
     * @param word
     * @return the review sentiment of the word as a floating-point number in the interval [0.0, 4.0] if known, and -1.0
     *         if unknown
     */
